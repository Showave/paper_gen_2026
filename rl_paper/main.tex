...
unbiased. A Lagrangian constraint on expected response length makes length part
of the declared objective rather than an implicit per-token normalization. This
