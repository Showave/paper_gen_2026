...
checks $w\le1/\alpha$, and injects omitted-prompt-ratio and weight-clipping
errors. This is an equation and software audit, not model-training evidence;
its outputs cannot populate \cref{tab:main}.
