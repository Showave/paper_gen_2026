...
information is
\begin{equation}
\operatorname{EVI}_{t-1}(x)=R(\mathcal F_{t-1})-
\sum_{y\in\{-1,0,1\}}\widehat p_{t-1}(y\mid x)
R\{\mathcal F_{t-1}\cup(x,y)\}.
\end{equation}
Using predeclared temperature $\lambda_E$, define
\begin{align}
r_t(x)&=\frac{\exp\{\lambda_E\operatorname{EVI}_{t-1}(x)/k_x\}}
{\sum_{x'}\exp\{\lambda_E\operatorname{EVI}_{t-1}(x')/k_{x'}\}},\\
...
\toprule
Design & Human labels & $\widehat\Delta_F$ & 95\% interval
& Tie rate & Decision \\
\midrule
Target-random human-only & -- & -- & -- & -- & pending \\
Static independent calibration & -- & -- & -- & -- & pending \\
PPAT-style residual acquisition & -- & -- & -- & -- & pending \\
EVI, unaugmented & -- & -- & -- & -- & pending \\
EVI + sequential augmentation & -- & -- & -- & -- & pending \\
Sealed uniform audit & -- & -- & -- & -- & pending \\
\bottomrule
\end{tabular}
\end{small}
\end{table*}
