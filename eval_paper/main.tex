...
human sampling, static independent calibration, Active Testing, control-variate
evaluation, PPAT-style residual acquisition, variance-optimal residual
sampling, pure uncertainty sampling, and EVI. Each acquisition policy is crossed with the same valid
...
cost, nonresponse rule, and planned simulation factor levels. These values specify a
public pre-pilot; they do not replace a deployment-log sampling design.
